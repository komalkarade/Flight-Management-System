            ...
            <tr>
              ...
              <td>
                <a
                  ...
                  href="/airport/update/${airport.airportCode}"
                  >Update</a
                >
              </td><td>
               <a
                  class="btn-update"
                  style="background-color: #A34343; color: black"
                  href="/airport/delete/${airport.airportCode}"method="post" onsubmit="return confirm('Are you sure you want to delete this airport?');"
                  >Delete</a
                >
